...
public class FileUtils extends org.apache.commons.io.FileUtils {
	 ...
	 * @param request 请求路径
	 * @return
	 * @返回值： Map<String,String>(type文件类型-音频语音视频缩略图,path文件路径,oldName上传文件名,newName保存的文件名,suffixName后缀名)
	 *
	 * @修改记录（修改时间、作者、原因）：
	 */
	public static Map<String,Object> upload(MultipartFile multipartFile,String uploadPath,HttpServletRequest request){
       ...
       //上传文件路径(路径+newName)
       uploadPath += File.separator + newName;
