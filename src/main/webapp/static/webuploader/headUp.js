...
/*	// 文件上传成功，给item添加成功class, 用样式标记上传成功。
	...
	*/
	...
	uploader.on('uploadSuccess', function(file,json) {
		...
		var currentphoto=eval(json);
		//alert()
		//console.log(currentphoto._raw);
		var filename=currentphoto._raw;
		$(window.parent.updatefilename(filename));
		$('#' + file.id).addClass('upload-state-done');
	});
	// 文件上传失败，现实上传出错。
