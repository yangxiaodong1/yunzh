...
function operationFun(){
	...
	//凭证-操作-删除-确认
	$("body").on("click","#feedback-save",function(){
		$.ajax( {    
		    url:ctx+'/billinfo/tDealBillInfo/feedBack',
		    data:{    
		    	"billId":$("#dillog-big-bill-info-id").val(),
		    	"feedReason":$("#feedback-error").text()
		    },    
		    type:'post',    
		    cache:false,    
		    dataType:'json',    
