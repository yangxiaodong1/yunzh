...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/taxbase/tTaxbase/">税基数表列表</a></li>
		<li class="active"><a href="${ctx}/taxbase/tTaxbase/form?id=${tTaxbase.id}">税基数表<shiro:hasPermission name="taxbase:tTaxbase:edit">${not empty tTaxbase.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="taxbase:tTaxbase:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="tTaxbase" action="${ctx}/taxbase/tTaxbase/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="taxbase:tTaxbase:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
