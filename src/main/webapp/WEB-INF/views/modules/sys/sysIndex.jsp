	...
	<div id="main">
			...
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li id="userInfo" class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="${ctx}/sys/user/info" target="mainFrame"><i class="icon-user"></i>&nbsp; 个人设置</a></li>
							<!--  
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By 汇智容大 ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
