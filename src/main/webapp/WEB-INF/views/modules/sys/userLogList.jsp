...
.table-center > tbody > tr > td.tleft{text-align:left;}
</style>
...
<div class="pad_15_10">
	<div class="panel panel-default mar_b0 radius0 border_none">
		...
		<form:form id="searchForm" action="${ctx}/sys/log/userLog" method="post">
		...
		<table id="contentTable" class="table table-bordered table-center table_hover2 font_cc9 table_vmiddle">
			<thead>
			...
			<c:forEach items="${page.list}" var="log">
				<tr>
					<td class='tleft'>${log.title}</td>
					<td class='tleft'><strong>${log.requestUri}</strong></td>
					<td>${log.method}</td>
