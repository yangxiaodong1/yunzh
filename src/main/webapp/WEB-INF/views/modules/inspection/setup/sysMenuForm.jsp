...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/inspection/setup/sysMenu/">菜单表列表</a></li>
		<li class="active"><a href="${ctx}/inspection/setup/sysMenu/form?id=${sysMenu.id}">菜单表<shiro:hasPermission name="inspection:setup:sysMenu:edit">${not empty sysMenu.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="inspection:setup:sysMenu:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sysMenu" action="${ctx}/inspection/setup/sysMenu/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="inspection:setup:sysMenu:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
