...
<body>
	<div class="c-right clearfix">
			<div class="edit">
				...
				<h2 class="h2-tit">插入凭证</h2>
				<input type="hidden" id="accountPeriod" value="${accountPeriod}">
				<div class="th clearfix">
					...
					<div class="th-right clearfix">
						<span id="insert" class="a-insert">插入凭证</span>
					</div>
				</div>
...
$("body").on("input propertychange",".inp-sub",function(){
	...
	$("body").on("click","#insert",function(){
		...
		$.ajax({
		     type: 'POST',
		     url: ctx+'/voucher/tVoucher/insert',
		     cache:false,  
		     dataType:'json',
		     data: {
