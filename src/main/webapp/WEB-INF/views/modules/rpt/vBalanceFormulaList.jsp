...
<html>
<head>
	<title>资产负债公式表-在线会计-芸豆会计</title>
	<meta name="decorator" content="default"/>	
</head>
<body>
<form:form id="inputForm" modelAttribute="tAcctreportitem" action="${ctx}/rpt/formula/saveBalance" method="post" class="form-horizontal">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${listEFormula}" var="eformula">
			<tr>
				...
				<td>
					<a href="${ctx}/rpt/formula/deleteBalance?id=${eformula.acctReportItemId }&reportitemId=${ eformula.reportitemid}&accountPeriod=${eformula.accountperiod}" onclick="return confirmx('确认要删除该报表公式科目吗？', this.href)">删除</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
