...
<script type="text/javascript" src="${ctxStatic}/jquery/jquery.validate2.js"></script>
...
.sta_form{position:relative;width:auto;display:inline-block;}
.form-control-feedback{height:24px;line-height: 24px;right:-25px;}
</style>
</head>
...
<div class="pad_15_10">
	<div class="panel panel-default mar_b0 radius0 border_none pad_10 ">
		<div class="panel panel-default mar_b0 radius0 border_i4 ">
			<div class="pad_lr_35">
				<div class="hr15"></div>
				<form:form id="inputForm" modelAttribute="tChargecompany" action="" method="post" class="form-horizontal form-horizontal2" enctype="multipart/form-data" autocomplete="off">
		             <form:hidden path="id"/>
		            <!-- <input id="feedFiles" type="hidden" name="feedFiles" value="" /> 用于保存每一次上传的图片id,然后保存 -->
				...
				<div class="font_cc10">
								...
								<div class="form-group">
									...
									<!-- </br>
									验证不能为空  <input type="text" class="form-control ipt_w4" value="" name="ces" id="ces"> --> 
					 ...
					 <div class="col-sm-9" id="city_china_val">
					        <div class="sta_form">
										...
										<option></option> 
										 ...
										 <form:select class="form-control ipt_wauto city select" data-first-title="选择市" path="city2" id="shi" name="shi">
										<option></option> 
										</form:select>
										<form:select class="form-control ipt_wauto area select" data-value="" data-first-title="选择地区" path="city3">
										<option></option>
										</form:select>
		...
		<div class="hr15"></div>
			...
			<div class="form-group">
				<label class="control-label w100 left mar-rig10" style="text-align:right;">用户登录名</label>				
				 <input type="text" class="form-control ipt_w4 depNameed " name="depNameedd" id="depNameedd"  />
				 <!-- <input type="text" class="form-control ipt_w4  " name="kk" id="kk"  />	 -->
				 <span id="span1" style="color:red;padding-left:110px;"></span>			
			</div>
			<div class="form-group">
				<label class="control-label w100 left mar-rig10" style="text-align:right;">密码</label>				
				 <input type="password" style="display:none;" />
				 <input type="password" class="form-control ipt_w4"  name="pwdd" id="pwdd" autocomplete="off" />				
			</div>
...
<!-- 
<form  action="${pageContext.request.contextPath}/a/newcharge/tChargecompany/fileUpload2" enctype="multipart/form-data" method="post">
...
jQuery.validator.addMethod("alnum", function(value, element) {
	...
	//var vald=/^[^\s]+$/;
	var vald=/^[^\s'"!@#$%]+$/;
	return  this.optional(element) ||vald.test(value);
...
$(document).ready(function(){
	  //用于验证老密码的
	  $("#depNameedd").blur(function(){
	   var depNameedd= $("#depNameedd").val();
	   $("#span1").empty();
	/*   if(depNameedd.indexOf(" ")> -1){
		 $("#span1").text("输入字符不能有空格");
	  } */
	  if(depNameedd.length<4){
			 $("#span1").text("输入字符不能小于4位");
		  }
	  var reg=/^[^\s'"!@#$%]+$/;
	  if(!reg.test(depNameedd)){
		  $("#span1").text("输入字符不能含有空格和特殊字符");
	  }
	 // alert(depNameedd);
