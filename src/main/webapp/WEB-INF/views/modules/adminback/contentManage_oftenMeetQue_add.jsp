...
<div class="pad_15_10">
	<div class="panel panel-default mar_b0 radius0 border_none">
		<form:form id="inputForm" modelAttribute="tcomquest" action="${ctx}/comquestion/tcomquest/savecomQuest" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<div class="panel-heading bg_col_2 panel-head-pub">
			<div class="left pad_t_3">
				<span class="glyphicon glyphicon_a9 ico_pub bg_pub mar-top2" aria-hidden="true"></span><span class="font_cc8 mar-rig10 font-14">常见问题添加</span>
		...
		<div class="panel-body">
			...
			<!--  	<form:textarea path="content" id="content" htmlEscape="true" rows="8" maxlength="255" class="input-xxlarge form-control" style="display:inline-block;width:600px;border-radius:0;border-color:#999999;resize:none;"/>
			    <sys:ckeditor replace="content" uploadPath="/cms/article" />
			   
			     -->
			     <div class="left" style="width:700px">
				    <form:textarea id="contentt" htmlEscape="true" path="content" rows="4" maxlength="200" style="width:100%;" class="input-xxlarge"/>
					<sys:ckeditor replace="contentt" uploadPath="/cms/site" />
				</div>
